...
st.markdown(
    ...
    .hero h1, .hero h1 * {font-family:'Amiri','Traditional Arabic',serif!important;font-weight:400!important;color:#f1eee5;font-size:5rem;line-height:1.2;margin:0;}
    .hero p {color:#a8a79f;font-size:1rem;margin:.2rem auto;}
    .eyebrow {color:#caa766;font-size:.8rem;letter-spacing:.05em;}
    .section-title {direction:rtl;text-align:right;color:#eee9dd;font-family:'Amiri','Traditional Arabic',serif!important;font-weight:400;font-size:2rem;margin:2.3rem 0 .3rem;}
    ...
    [data-testid="InputInstructions"], [data-testid="stInputInstructions"] {display:none!important;visibility:hidden!important;}
    div[data-testid="stTextInput"] [data-baseweb="input"], div[data-testid="stTextInput"] [data-baseweb="input"]:focus-within {border-color:#424a5c!important;outline:none!important;box-shadow:none!important;}
    div[data-testid="stTextInput"]:focus-within [data-baseweb="input"] {border-color:#d8ba7f!important;}
    ...
    div[data-testid="stButton"] button:focus, div[data-testid="stButton"] button:focus-visible {border-color:#d8ba7f!important;outline:none!important;box-shadow:none!important;}
